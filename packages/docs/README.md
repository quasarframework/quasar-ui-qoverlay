...
This package contains the Q-Press documentation site for QOverlay. It owns the public documentation source, live demos, example-viewer content, generated API pages, and static-search output for overlay, modal, and layered UI examples.
