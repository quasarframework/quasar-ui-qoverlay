    ...
    build: {
      ...
      typescript: {
        ...
        extendTsConfig(tsConfig) {
          ...
          tsConfig.compilerOptions.paths['@quasar/quasar-ui-qoverlay'] = ['./../../ui/src/index.ts']
          tsConfig.compilerOptions.paths['@quasar/quasar-ui-qoverlay/dist/api/*'] = [
            './../../ui/dist/api/*',
          ]
        },
      },
