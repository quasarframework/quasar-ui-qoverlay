  ...
  <section class="landing-page markdown-brand">
    ...
    <section class="resource-section">
      ...
      <article class="resource-card resource-card--secondary">
        ...
        <h2 class="resource-card__title">Start with the intro, then move into the real usage patterns</h2>
        <p class="resource-card__body">
          The docs are meant to get you to a working overlay quickly. If something feels off,
          GitHub Discussions and the repo issue tracker are still the best places to surface it.
        </p>
...
const sectionTitle = "A focused overlay component for blocking states, loading flows, and custom surface messaging";
const sectionText =
...
.resource-card {
  ...
  box-shadow: 0 16px 34px rgba(28, 12, 10, 0.16);
}
