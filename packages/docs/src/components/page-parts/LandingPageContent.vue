<template>
  <section class="landing-page markdown-brand">
    <header class="hero">
      <img src="/app-logo.svg" alt="QOverlay Logo" class="hero-logo" />
      <h1 class="hero-title">QOverlay</h1>
      ...
      <div class="hero-buttons">
        ...
        <a
          href="https://github.com/quasarframework/quasar-ui-qoverlay/tree/v3-beta"
          target="_blank"
    ...
    <div class="byline">
      <p>
        Add focused blocking states to a full page, a card, or any component that needs to pause
        interaction while work completes.
      </p>
    </div>
    ...
    <div class="byline">
      <p>
        ...
        <a href="https://github.com/quasarframework/quasar-ui-qoverlay" target="_blank">
          QOverlay GitHub repo
        </a>
        and the
    ...
    <div class="byline">
      <p>
        ...
        assistance, please reach out through the QOverlay repository or GitHub Discussions.
      </p>
    </div>
  </section>
</template>
