  ...
  children: [
    {
      name: "GitHub",
      icon: fabGithub,
      path: `https://github.com/quasarframework/quasar-ui-qoverlay/tree/${repoBranch}`,
      external: true,
    },
    {
      name: "X (Twitter)",
...
const config: SiteConfig = {
  ...
  githubEditRootSrc: `https://github.com/quasarframework/quasar-ui-qoverlay/edit/${repoBranch}/packages/docs/src`,
  githubSourceRootSrc: `https://github.com/quasarframework/quasar-ui-qoverlay/tree/${repoBranch}/packages/docs/src`,
  license: {
    label: "MIT License",
    link: `https://github.com/quasarframework/quasar-ui-qoverlay/blob/${repoBranch}/LICENSE`,
  },
  privacy: {
    label: "Contact",
    link: "/other/contact",
