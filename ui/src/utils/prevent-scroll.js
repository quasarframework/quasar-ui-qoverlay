import { getEventPath, listenOpts, stopAndPrevent } from './event.js'
...
function apply (action, $q) {
  ...
  if ($q.platform.is.desktop === true && $q.platform.is.mac === true) {
...
export default function (state) {
  ...
  if (state === true) {
    ...
    if ($q.platform.is.ios === true && $q.platform.is.nativeMobile === true) {
      clearTimeout(closeTimer)
